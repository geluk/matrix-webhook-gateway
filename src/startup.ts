...
import SubscriptionAgent from './feeds/SubscriptionAgent';
import FeedRepository from './repositories/FeedRepository';
import FeedService from './feeds/FeedService';
import downloader, { needsDownload } from './downloads/downloader';

export default async function startup(
  clearPluginCache: boolean,
  autoMigrate: boolean,
  ...
  const feedSubscriptionAgent = new SubscriptionAgent(
    feedRepository,
    feedService,
  );
